...
Revision ID: 887da82d0f55
Revises: 
Create Date: 2026-05-24 18:52:21.695843
...
def upgrade():
    ...
    sa.Column('visibility_reasoning', sa.Text(), nullable=True),
    sa.Column('visibility_confidence', sa.String(length=20), nullable=True),
